...
`NeonDash` est un jeu de survie arcade solo integre a la borne.
Le joueur doit esquiver des orbes qui traversent l'arene et utiliser
un dash pour survivre le plus longtemps possible.

Controles :
- joystick J1 : deplacement
- bouton J1 A : dash
- bouton J1 B : pause / reprise
- bouton J1 Z : quitter et revenir au menu

Fichiers d'integration :
- `projet/NeonDash/description.txt`
- `projet/NeonDash/bouton.txt`
- `projet/NeonDash/photo_small.png`
- `projet/NeonDash/photo.png`
